    ...
    <div className="pt-12 md:pt-14">
      ...
      <div className="pt-6 pb-8 flex flex-col md:flex-row justify-between gap-x-0 md:gap-x-14 gap-y-6 md:gap-y-0 ">
        <div className="w-full md:w-2/3">
          <h2 className="text-black dark:text-primary text-4xl md:text-[40px] font-semibold leading-[1.2] [-0.01em]  font-primary">
            {heading}
          </h2>
          <p className="font-secondary text-sm md:text-base font-normal dark:text-primary-light mt-5 leading-[1.36] tracking-[-0.02em]">
            {description}
          </p>
          <div className="flex gap-2 mt-8">
            <TertiaryButton
              className="h-8 border-default-500 dark:border-default-100 bg-inherit dark:text-primary-light text-xs font-secondary"
              showIcon={false}
            >
              {firstButtonLable}
            </TertiaryButton>
        ...
        <div className="w-full md:w-1/3">
          <div className="border-1 border-default-50 dark:border-y-default-50 dark:border-x-default-200 p-4 rounded-[10px] dark:bg-dark-gradient">
            <ul>
              {processSlutions.map((item, index) => (
                <li
                  key={index}
                  className="flex items-center  dark:text-primary"
                >
