  ...
  return (
    <div className="pt-20 md:pt-32 pb-6 md:pb-10">
      <div>
        ...
        <p className="font-secondary font-normal text-sm md:text-lg dark:text-primary-light mt-3 md:mt-4 leading-[1.2] tracking-[-0.04em]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
        <div className="dark:bg-dark-gradient p-10 rounded-md border border-default-200 dark:border-y-default-50 dark:border-x-default-200">
          <h3 className="dark:text-primary text-3xl md:text-4xl leading-[48px] tracking-[-2px] font-semibold font-primary">
            {" "}
            Nexbit Studio
          </h3>
