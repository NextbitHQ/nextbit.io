...
const CompareFeature: React.FC<CompareFeatureProps> = ({ title,titleShow,borderShow, items, icon: Icon }) => {
    return (
        <div className={`bg-inherit p-3 rounded-md ${ borderShow && 'border border-default-200 dark:border-y-default-50 dark:border-x-default-200'}`}>
            {titleShow&&
