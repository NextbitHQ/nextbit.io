...
export default function TeamFeature({ title, heading, description }: TeamFeatureProps) {
    return (
        <div>
            ...
            <div className="pt-6 pb-8 flex flex-col gap-x-0 md:gap-x-14 gap-y-6 md:gap-y-0">
                <div className="w-full">
                    <h2 className="text-black dark:text-primary text-4xl font-semibold leading-[1.2] [-0.01em] font-primary">{heading}</h2>
